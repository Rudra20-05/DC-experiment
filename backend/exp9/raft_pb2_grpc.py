...
class RaftServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.RequestVote = channel.unary_unary(
                '/raft_demo.RaftService/RequestVote',
        ...
        self.AppendEntries = channel.unary_unary(
                '/raft_demo.RaftService/AppendEntries',
...
def add_RaftServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'raft_demo.RaftService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('raft_demo.RaftService', rpc_method_handlers)
